...
- **Guide me here (navigation target)**: tap/select a pin → “Guide me here” → your compass arrow targets that pin and shows its name; teammates see a secondary toast like “Jessica is navigating to ‘Ramen Stall’”
...
The experience is built around knowing where your people are, sharing what catches your eye in the moment, and staying in motion. You can pin places you see, which integrates directly with the device camera: frame something you want to share and the pin is dropped from the live view. When someone drops a pin you care about, you can select it and choose **Guide me here**—your compass retargets so you can converge without stopping to text.
...
**Guide me here (MVP)** lets you select a pin and retarget your compass toward it so you can converge quickly without texting. The compass shows the pin’s name under the arrow while it’s the active target.
